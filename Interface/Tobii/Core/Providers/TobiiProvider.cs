...
namespace Tobii.XR
{
    ...
    public class TobiiProvider : IEyeTrackingProvider
    {
        ...
        private float3 _foveatedGazeDirectionLocal;
        private StreamEngineTracker _streamEngineTracker;
        private CameraPoseHistory _cameraPoseHistory;
        private float4x4 _localToWorldMatrix;
        private float3 _headToCenterEyeTranslation;
        ...
        public float3 FoveatedGazeDirectionLocal => _foveatedGazeDirectionLocal;
