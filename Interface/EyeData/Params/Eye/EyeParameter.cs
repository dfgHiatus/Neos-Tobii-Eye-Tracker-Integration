...
using NeosTobiiEyeIntegration.EyeData;
using NeosTobiiEyeIntegration.EyeData.Params;
using BaseX;

namespace Neos_Tobii_Eye_Integration.EyeData.Params.Eye
{
    ...
    {
        public XYParameter(Func<EyeTrackingData, float2?> getValueFunc, string xParamName, string yParamName)
